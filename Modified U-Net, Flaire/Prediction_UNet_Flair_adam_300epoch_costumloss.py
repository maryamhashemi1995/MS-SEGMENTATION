...
plt.title("DSC Scatter Plot for Test Data", fontsize='40')	#title
plt.scatter( counter_array,DSC_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='40')	#adds a label in the x axis
plt.ylabel("DSC",fontsize='40')	#adds a label in the y axis
...
plt.title("IOU Scatter Plot for Test Data", fontsize='24')	#title
plt.scatter( counter_array,IOU_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='24')	#adds a label in the x axis
plt.ylabel("IOU",fontsize='24')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
plt.xlabel("Number of Image",fontsize='36')	#adds a label in the x axis
plt.ylabel("Sensevitity",fontsize='36')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
plt.title("Sensevitity Scatter Plot for Train Data", fontsize='36')	#title
plt.scatter( counter_array,sens_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='30')	#adds a label in the x axis
plt.ylabel("Sensevitity",fontsize='36')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
plt.title("Errore Rate Scatter Plot for Train Data", fontsize='36')	#title
plt.scatter( counter_array,errorrate_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='30')	#adds a label in the x axis
plt.ylabel("Errore Rate",fontsize='36')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
