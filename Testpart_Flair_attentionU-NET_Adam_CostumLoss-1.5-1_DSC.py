...
plot_model(model, to_file='model_flaire_attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.png')
# Save the weights
model.save_weights('model_weights_flaire_attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.h5')

# Save the model architecture
with open('model_architecture_flaire__attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.json', 'w') as f:
    f.write(model.to_json())
    
model.save('model_flaire__attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.h5')
