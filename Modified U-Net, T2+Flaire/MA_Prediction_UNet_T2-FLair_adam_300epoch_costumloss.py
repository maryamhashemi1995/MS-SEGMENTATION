# -*- coding: utf-8 -*-
"""
Created on Fri Jun  4 12:10:18 2021

@author: Mahsa Akhbari
"""
...
with open("C:/Users/MaryamHashemi/Downloads/Results_T2_FLAIR_UNET_DSC_ADAM_COSTUMLOSS1.5,1_EPOCHS300_learning/Results_T2_FLAIR_UNET_DSC_ADAM_COSTUMLOSS1.5,1_EPOCHS300_learning/model_architecture_T2+flaire__UNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.json", 'r') as f:
        model = tf.keras.models.model_from_json(f.read())
  
#     Load weights into the new model
model.load_weights('C:/Users/MaryamHashemi/Downloads/Results_T2_FLAIR_UNET_DSC_ADAM_COSTUMLOSS1.5,1_EPOCHS300_learning/Results_T2_FLAIR_UNET_DSC_ADAM_COSTUMLOSS1.5,1_EPOCHS300_learning/model_weights_T2+flaire_UNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.h5')
...
def parameters(TP_array,TN_array,FP_array,FN_array):
    ...
    npv_array=[]
    count=0
    for i in range(0,preds_test.shape[0]-1-1): ############# add by Mahsa (add -1)
        if i!=86 and i!=171:
            print(i)
