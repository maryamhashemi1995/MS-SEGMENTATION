...
def custom_loss(y_true, y_pred):
    ...
    return 2*generalized_dice_loss(y_true, y_pred) +  binary_crossentropy(y_true, y_pred)
...
def Attention_U_Net_2D(image_shape, activation,
    ...
    if optimizer == "sgd":
        ...
        #opt = tf.keras.optimizers.Adam(lr=0.01, beta_1=0.9, beta_2=0.999, epsilon=None, decay=0.0,amsgrad=False)
    else:
