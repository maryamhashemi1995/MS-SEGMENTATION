...
#generally we have 128*128*1413 pixels. some them are white(lesion) and others are black(background)
...
def parameters(TP_array,TN_array,FP_array,FN_array):
    ...
    npv_array=[]
    count=0
    for i in range(0,preds_test.shape[0]-1-4): ############ Edit by Mahsa
...
print("Mean of Sensevitity for Test data is:", (statistics.mean(sens_array)))
print("Variance of Sensetivity for Test data is:", (statistics.variance(sens_array)))
...
plt.title("Sensevitity Scatter Plot for Test Data", fontsize='16')	#title
plt.scatter( counter_array,sens_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='13')	#adds a label in the x axis
plt.ylabel("Sensevitity",fontsize='13')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
plt.savefig('Sensevitity_array.png')	#saves the figure in the present directory
plt.grid()	#shows a grid under the plot
plt.show()
...
plt.title("Errore Rate Scatter Plot for Test Data", fontsize='16')	#title
plt.scatter( counter_array,errorrate_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='13')	#adds a label in the x axis
plt.ylabel("Errore Rate",fontsize='13')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
print("Mean of Sensevitity for Train data is:", (statistics.mean(sens_array)))
print("Variance of Sensetivity for Train data is:", (statistics.variance(sens_array)))
...
plt.title("Sensevitity Scatter Plot for Train Data", fontsize='16')	#title
plt.scatter( counter_array,sens_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='13')	#adds a label in the x axis
plt.ylabel("Sensevitity",fontsize='13')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
plt.title("Errore Rate Scatter Plot for Train Data", fontsize='16')	#title
plt.scatter( counter_array,errorrate_array,color='red', marker='o')	#plot the points
plt.xlabel("Number of Image",fontsize='13')	#adds a label in the x axis
plt.ylabel("Errore Rate",fontsize='13')	#adds a label in the y axis
#plt.legend(('YvsX'),loc='best')	#creates a legend to identify the plot
...
print(ix)
plt.subplot(1,3,1)
plt.imshow((X_train[int(X_train.shape[0]*0.85):][ix])/256) ############# edit by mahsa, change 0.9 to 0.85
plt.title('MRI Scan (Validation Set)')
plt.subplot(1,3,2)
plt.imshow(np.squeeze(Y_train[int(Y_train.shape[0]*0.85):][ix]))   ############# edit by mahsa, change 0.9 to 0.85
