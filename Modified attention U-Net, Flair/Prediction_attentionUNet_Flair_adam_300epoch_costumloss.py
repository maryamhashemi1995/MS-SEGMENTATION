...
with open("C:/Users/MaryamHashemi/Desktop/MS/Results/attentionUNet-DSC-costumloss-adam/Flaire_attentionUNET_metric=DSC,opt=adam,loss=costumloss-1.5-1,epochs=300/model_architecture_flaire__attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.json", 'r') as f:
        model = tf.keras.models.model_from_json(f.read())
     
#     Load weights into the new model
model.load_weights('C:/Users/MaryamHashemi/Desktop/MS/Results/attentionUNet-DSC-costumloss-adam/Flaire_attentionUNET_metric=DSC,opt=adam,loss=costumloss-1.5-1,epochs=300/model_weights_flaire_attentionUNET_challenge2015_Adam_Cstumloss-1.5-1_DSC.h5')
